...
For complex datasets with multiple samples, you can facet by sample to inspect
each sample in its own panel. When `facet_by_sample = TRUE`, sample faceting
overrides replicate faceting.
...
```{r single-sample-growth-curve, fig.width=8, fig.height=5}
plot_growth_curve(
  se,
