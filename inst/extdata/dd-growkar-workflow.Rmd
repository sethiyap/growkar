...
such as `KN99`, `CM2444`, `CM2446`, and `CM2448`. Colors are shared by dose
across families, so conditions such as `KN99(0)`, `CM2444(0)`, `CM2446(0)`,
and `CM2448(0)` use the same color key.
