...
`growkar` converts the processed data directly into a `GrowthExperiment` (an S4
extension of `SummarizedExperiment`),
the canonical container used throughout the package. This example keeps the full CDK7 dataset in
