...
When condition labels include dose values in parentheses, colors are shared by
dose across facets. For example, `KN99(0)`, `CM2444(0)`, `CM2446(0)`, and
`CM2448(0)` use the same color key.
